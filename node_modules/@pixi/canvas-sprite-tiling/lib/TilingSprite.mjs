...
const worldMatrix = new Matrix(), patternMatrix = new Matrix(), patternRect = [new Point(), new Point(), new Point(), new Point()];
TilingSprite.prototype._renderCanvas = function(renderer) {
  ...
  if (this._textureID !== this._texture._updateID || this._cachedTint !== this.tintValue) {
    ...
    const tempCanvas = new utils.CanvasRenderTarget(
      texture._frame.width,
      texture._frame.height,
      baseTextureResolution
    );
    this.tintValue !== 16777215 ? (this._tintedCanvas = canvasUtils.getTintedCanvas(this, this.tintValue), tempCanvas.context.drawImage(this._tintedCanvas, 0, 0)) : tempCanvas.context.drawImage(
      source,
